...
def index():
    ...
    if request.method == "POST":
        ...
        try:
            ...
            prompt = (
                ...
                "Look at the text and suggest a different writing style and explain also in what kind of situation is better to use it"
                ...
                "    }\n"
                "  ],\n"
                "  'recommended_style':  'Example of an alternative writing style.\\n"
                "                    \\n 'Explain what kind of style is the recommended one and in what situations to better use this alternative writing style.\\n"
                "}\n\n"
        ...
        # Parse the response
            ...
            recommended_style = response_json.get("recommended_style", "")
    ...
    return render_template("index.html", checked_text=checked_text, original_text=original_text, errors=errors, recommended_style=recommended_style)
